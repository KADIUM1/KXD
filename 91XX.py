...
""")
    ...
    print(Fore.WHITE + "[" + Fore.GREEN + "STUB MAKER" + Fore.WHITE + "]" + Fore.BLUE + ": Command:  /wm (whatsapp message)")
...
Enjoy: :)""")
    ...
    if drr == ("/wm"):
        clear()
        number2 = input(Fore.GREEN + "[ + ]" + Fore.BLUE + ":" + Fore.WHITE + " Number to Bomb-Message >> ")
        message = input(Fore.GREEN + "[ + ]" + Fore.BLUE + ":" + Fore.WHITE + " Message to Bomb Message >> ")
        hour = input(Fore.GREEN + "[ + ]" + Fore.BLUE + ":" + Fore.WHITE + " Time hour >> ")
        minute = input(Fore.GREEN + "[ + ]" + Fore.BLUE + ":" + Fore.WHITE + " Time minute >> ")
        pywhatkit.sendwhatmsg(number2, message, hour, minute)
        exit = input(Fore.RED + "Press Enter to go back...")
        clear()
        STUB()
